...
if (isset($_POST['update'])) {
    ...
    if ($stmt = mysqli_prepare($conn, $query)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            header('Location: applicants_profile_account.php');
        } else {
    ...
    <div class="container-fluid py-4 px-5">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <form name="update_profile" action="applicants_profile_account.php" method="post" enctype="multipart/form-data" class="height-content-profile_account">
                    <?php
