            ...
            <div class="container-fluid px-4">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $total_query = "SELECT COUNT(*) FROM salarys";
                        $total_result = mysqli_query($conn, $total_query);
                        $total_row = mysqli_fetch_row($total_result);
                        $total_records = $total_row[0];
                        $total_pages = ceil($total_records / $limit);

                        $query = "SELECT * FROM salarys LIMIT $limit OFFSET $offset";
                ...
                <nav class="d-flex justify-content-between" style="align-items: start;">
                    <button class="btn btn-light fw-bold border border-dark" data-bs-toggle="modal" data-bs-target="#add_salary_data">
...
<div class="modal fade" id="add_salary_data" tabindex="-1" aria-labelledby="add_salary_data" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="add_salary_data">เพิ่ม salary data</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="add_salary_data.php" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 mb-1">
                            <label for="salary_data" class="fs-5 fw-normal" style="color: #64748b;">จำนวนเงินเดือน</label>
                            <input type="text" name="salary_data" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button name="add_salary_data" class="btn btn-lg btn-primary me-2 fw-medium" type="submit" style="font-family: 'Kanit', sans-serif !important;">บันทึก</button>
