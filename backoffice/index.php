...
<script>
    <?php if (isset($_SESSION['update_approve'])): ?>
        Swal.fire({
            icon: 'success',
            title: 'สำเร็จ',
            text: '<?php echo $_SESSION['update_approve']; ?>'
        });
        <?php unset($_SESSION['update_approve']); ?>
    <?php endif; ?>

    <?php if (isset($_SESSION['update_disapprove'])): ?>
        Swal.fire({
            icon: 'success',
            title: 'สำเร็จ',
            text: '<?php echo $_SESSION['update_disapprove']; ?>'
        });
        <?php unset($_SESSION['update_disapprove']); ?>
    <?php endif; ?>
</script>
